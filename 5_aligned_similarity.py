...
output_csv = "embeddings/aligned_similarities.csv"  # Different filename to avoid overwriting
...
print("\nImages with highest similarity (most similar):")
...
print("\nImages with lowest similarity (most different):")
