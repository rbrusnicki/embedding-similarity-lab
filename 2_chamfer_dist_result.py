...
# Configuration
distances_csv = "embeddings/chamfer_distances.csv"
image_dir = "frames_covla_1k"
output_dir = "chamfer_comparison_images"
...
def create_comparison_image(img1_path, img2_path, distance, output_path, title):
    ...
    plt.suptitle(f"{title}\nChamfer Distance: {distance:.4f}", fontsize=16)
...
def main():
    # Load distances CSV
    print(f"Loading distances from {distances_csv}")
    try:
    ...
    print(f"\nProcessing {n_pairs} most similar image pairs...")
